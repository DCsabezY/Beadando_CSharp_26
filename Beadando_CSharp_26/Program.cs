...
namespace Beadando_CSharp_26
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // Consumer szál: azonnal várakozni kezd, amíg a főszál filmet nem ad hozzá
            ...
            // Sorrend fontos: Stop() jelez a consumernek, Join() megvárja, csak utána Close()
            // (fordítva vagy kihagyva deadlock, illetve erőforrás-hiba lenne)
            processor.Stop();
            consumerThread.Join();
            processor.Close();
